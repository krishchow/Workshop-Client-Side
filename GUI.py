...
class Application():
    ...
    def loadMain(self):
        ...
        tk.Button(buttonFrame,text="Get Pokemon",width=25,height=3,command=self.API.requestPOST).pack(side='top')
        tk.Button(buttonFrame,text="Create Pokemon",width=25,height=3,command=self.API.requestPUT).pack(side='top')
        tk.Button(buttonFrame,text="Get Your Pokemon",width=25,height=3,command=self.API.requestGET).pack(side='top')
        tk.Button(buttonFrame,text="Update Pokemon",width=25,height=3,command=self.API.requestPATCH).pack(side='top')
        tk.Button(buttonFrame,text="Delete Pokemon",width=25,height=3,command=self.API.requestDELETE).pack(side='top')
