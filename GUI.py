...
class Application():
    def __init__(self):
        ...
        self.root.style.configure('My.TButton', foreground='#000000',background='#ecf0f1',borderwidth=0)
    ...
    def loadMain(self):
        ...
        ttk.Button(buttonFrame,text="Indent Json",width=25,command=jsonText.indent_json).pack(side='top',ipady=10)
        ttk.Button(buttonFrame,text="Clear Json",width=25,command=jsonText.clear).pack(side='top',ipady=10)
        ttk.Button(buttonFrame,text="Get Pokemon",width=25,command=self.API.requestPOST).pack(side='top',ipady=10)
        ttk.Button(buttonFrame,text="Create Pokemon",width=25,command=self.API.requestPUT).pack(side='top',ipady=10)
        ttk.Button(buttonFrame,text="Get Your Pokemon",width=25,command=self.API.requestGET).pack(side='top',ipady=10)
        ttk.Button(buttonFrame,text="Update Pokemon",width=25,command=self.API.requestPATCH).pack(side='top',ipady=10)
        ttk.Button(buttonFrame,text="Delete Pokemon",width=25,command=self.API.requestDELETE).pack(side='top',ipady=10)
